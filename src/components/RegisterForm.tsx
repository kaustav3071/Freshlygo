...
import { User, Mail, Lock, Eye, EyeOff, ArrowLeft, AlertCircle, Loader2 } from 'lucide-react';
                ...
                >
                    ...
                    <motion.div variants={itemVariant} className="text-center mb-8">
                        ...
                        <div className="flex items-center justify-center gap-2">
                            <p className="text-gray-500 text-sm">Join Snapcart today</p>
                            <motion.span
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.div variants={itemVariant}>
                            <div className="relative">
                                ...
                                <motion.input
                                    ...
                                    className={`w-full pl-12 pr-4 py-4 bg-gray-50 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 text-gray-700 placeholder-gray-400 ${touched.name && errors.name
                        ...
                        <motion.div variants={itemVariant}>
                            <motion.button
                                type="submit"
                                disabled={!isFormValid && (touched.name || touched.email || touched.password)}
                                className={`w-full font-semibold py-4 rounded-xl shadow-lg relative overflow-hidden transition-all duration-200 ${!isFormValid && (touched.name || touched.email || touched.password)
